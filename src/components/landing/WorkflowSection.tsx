...
export function WorkflowSection() {
  return (
    <section
      ...
      className="relative overflow-hidden bg-[#0e0e0e] py-[72px] md:py-[100px]"
    >
      {/* Subtle grid */}
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(255,255,255,.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.03)_1px,transparent_1px)] bg-[size:72px_72px]" />
      ...
      <div className="relative mx-auto w-[min(1180px,calc(100%-32px))] md:w-[min(1180px,calc(100%-40px))]">
        <div className="mb-8 md:mb-10">
          ...
          <h2
            ...
            className="mt-3 text-[36px] leading-[1.02] tracking-[-.05em] text-[#f5f5f0] md:text-[58px]"
          >
            How RAWI works.
          </h2>
        </div>
        ...
        <ol className="grid list-none gap-4 p-0 sm:grid-cols-2 lg:grid-cols-4">
          {WORKFLOW.map((step, index) => (
            <li
              key={step.number}
              className="group relative min-h-[230px] rounded-[24px] border border-white/8 bg-[#161616] p-6 shadow-[0_12px_35px_rgba(0,0,0,.3)] transition duration-300 hover:-translate-y-1 hover:border-white/15 hover:shadow-[0_20px_50px_rgba(0,0,0,.4)]"
            >
              ...
              <h3 className="mt-10 text-xl font-extrabold uppercase tracking-[-.02em] text-[#f5f5f0]">
                {step.title}
              </h3>
