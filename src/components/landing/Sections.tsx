...
const HERO_IMAGE = DEMO_PROJECTS[0]?.image ?? "";
          ...
          <div className="grid grid-cols-[132px_1fr] min-h-[480px]">
            ...
            <div className="p-5 md:p-6">
              ...
              <div className="mt-4 rounded-2xl border bg-white p-3 shadow-sm">
                ...
                <div className="grid grid-cols-5 gap-2 mt-3">{DEMO_PROJECTS.slice(0,5).map((project) => <DemoProjectCard key={project.name} project={project} />)}</div>
              </div>
